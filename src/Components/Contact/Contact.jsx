...
const Contact = () => {
  ...
  return (
    <main className="container section contactme">
        ...
        <form action="https://formspree.io/f/mlevdjdk" method="post" className="contactme-form">
            ...
            <div className="contactme-form__input">
                ...
                <input type="text" name="name" autoComplete='false'
                  className="contactme-form__input__input" 
                  id="contactme_name" placeholder="Ingrese su nombre" 
                required />
            </div>
            <div className="contactme-form__input">
                ...
                <input type="email" name="email"  autoComplete='false'
                  className="contactme-form__input__input" 
                  id="contactme_email" placeholder="Ingrese su email" pattern="\b[\w\.-]+@[\w\.-]+\.\w{2,4}\b" 
                required />
            </div>
            ...
            <div className="contactme-form__input">
                ...
                <textarea name="message" 
                  className="contactme-form__input__message" 
                  id="contactme_message" placeholder="Write your message" cols="200" rows="20" wrap="hard" required>
                </textarea> 
            </div>
            <div className="contactme-form__input">
                <button className="btn section__btn" id='sendBtn'>  
